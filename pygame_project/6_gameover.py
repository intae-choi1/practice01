...
while running:
    ...
    # 무기 위치 조정 + 천장에 닿은 무기 없애기
    weapons = [[w[0], w[1]-weapon_speed] for w in weapons if w[1] > -20]  # 무기 위치를 위로
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        else: # 그 외의 경우에는 속도 증가 (양수 증가니까 위로갈땐 조금씩 느려지게, 아래로갈떈 조금씩 빨라지게)
            ball_val["to_y"] += 0.5
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx < 3:
                    ...
                    balls.append({
                        ...
                        "to_x":-3, # x축 이동방향 (음수면 왼쪽으로)
                        "to_y":-3-3*(ball_img_idx+1), # y축 이동방향
